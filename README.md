...
written in Modula-3, it can create a bootstrap package consisting of mm3 itself compiled to C bootstrap source code.
...
compile and build. Other hand it does not work; it has the semblance of a linkage incompatibility between the gcc and llvm worlds.

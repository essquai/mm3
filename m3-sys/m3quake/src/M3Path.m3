...
CONST
  ...
  (* Unix *)       SMap { "", ".i3", ".ib", ".ic", "_i.s", "_i.o", "_i.wasm",
                          ".m3", ".mb", ".mc", "_m.s", "_m.o", "_m.wasm",
                          ".ig", ".mg", ".c", ".cpp", ".h", ".bc", ".s",
                          ".o", ".a", ".a", ".m3x", "", ".mx", ".tmpl" },
  (* GrumpyUnix *) SMap { "", ".i3", ".ib", ".ic", "_i.s", "_i.o", "_i.wasm",
                          ".m3", ".mb", ".mc", "_m.s", "_m.o", "_m.wasm",
                          ".ig", ".mg", ".c", ".cpp", ".h", ".bc", ".s",
                          ".o", ".a", ".a", ".m3x", "", ".mx", ".tmpl" },
  (* Win32 *)      SMap { "", ".i3", ".ib", ".ic", ".is", ".io", ".iw",
                          ".m3", ".mb", ".mc", ".ms", ".mo", ".mw",
                          ".ig", ".mg", ".c", ".cpp", ".h", ".bc", ".s",
                          ".obj",".lib",".lib",".m3x",".exe",".mx",".tmpl" },
  (* C++BackendWithAutomake *) SMap { "", ".i3", ".ib", ".ic", ".i3.s", ".i3.o", ".i3.w",
                          ".m3", ".mb", ".mc", ".m3.s", ".m3.o", "m3.w",
                          ".ig", ".mg", ".c", ".cpp", ".h", ".bc", ".s",
                          ".o", ".a", ".a", ".m3x", "", ".mx", ".tmpl" }
  };
